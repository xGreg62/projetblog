<?php
/* Smarty version 3.1.33, created on 2019-02-01 16:24:27
  from '/Applications/MAMP/htdocs/projetBlogV4/assets/smarty_tpl/article.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5c5464abc36a91_42370283',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9c332342bdec837cfc929387eb90b30400828253' => 
    array (
      0 => '/Applications/MAMP/htdocs/projetBlogV4/assets/smarty_tpl/article.tpl',
      1 => 1549034654,
      2 => 'file',
    ),
  ),
...
function content_5c5464abc36a91_42370283 (Smarty_Internal_Template $_smarty_tpl) {
...
<div class="container div_maincontent">
 ...
 alert-dismissible fade show" role="alert">
    ...
    <div class="col-lg-12 text-center">
      <h1><?php echo $_smarty_tpl->tpl_vars['tab_article']->value[0]['titre'];?>
</h1>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-lg-12 text-center margin">
        <div class="col-lg-7 text-center center">
            <p>Écrit par <b><?php echo $_smarty_tpl->tpl_vars['tab_article']->value[0]['nom'];?>
 <?php echo $_smarty_tpl->tpl_vars['tab_article']->value[0]['prenom'];?>
</b> le <b><?php echo $_smarty_tpl->tpl_vars['tab_article']->value[0]['datefr'];?>
</b></p>
            <img class="card-img-top margin" src="assets/imgs/<?php echo $_smarty_tpl->tpl_vars['tab_article']->value[0]['id'];?>
.jpg" alt="Pas d'image">
        </div>
          ...
          <div class="comment-tabs">
              ...
              <div class="tab-content">
                  <div class="tab-pane active" id="comments-display">
                      <ul class="media-list">
                                            <?php ob_start();
echo $_smarty_tpl->tpl_vars['tab_article']->value[0]['id_article'];
$_prefixVariable1 = ob_get_clean();
if ($_prefixVariable1 != NULL) {?>
                      <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['tab_article']->value, 'com');
if ($_from !== null) {
                        ...
                        <li class="media">
                          ...
                          <div class="media-body">
                            <div class="well well-lg">
                                <h4 class="media-heading text-uppercase reviews"><?php if ($_smarty_tpl->tpl_vars['com']->value['pseudo'] == '') {
echo $_smarty_tpl->tpl_vars['com']->value['email'];
} else {
echo $_smarty_tpl->tpl_vars['com']->value['pseudo'];
}?></h4>
                                <ul class="media-date text-uppercase reviews list-inline">
                                  <li class="dd"><?php echo $_smarty_tpl->tpl_vars['com']->value['datemsg'];?>
</li>
                                </ul>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                  ...
                  <div class="tab-pane" id="add-comment">
                      <form action="actions.php" onsubmit="return checkForm()" method="post" class="form-horizontal" id="commentForm">
                          ...
                          <input type="hidden" id="art_id" name="art_id" value="<?php echo $_smarty_tpl->tpl_vars['tab_article']->value[0]['id'];?>
">
...
if ($_prefixVariable2 == 1) {?> value="1" checked<?php }?> > Publié ?</input>
            </label>
          </div>
        </div>
